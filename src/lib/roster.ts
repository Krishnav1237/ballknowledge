...
export const TEAM_ROSTERS: Record<string, { name: string; position: 'GK' | 'DEF' | 'MID' | 'FWD'; specificPosition: 'GK' | 'LB' | 'CB' | 'RB' | 'LCM' | 'CDM' | 'RCM' | 'LW' | 'ST' | 'RW'; rating: number; team: string; flag: string }[]> = {
  ...
  "Crystal Palace": [
    ...
    { name: "Eberechi Eze", position: "MID", specificPosition: "RCM", rating: 86, team: "Crystal Palace", flag: "https://crests.football-data.org/354.png" },
  ...
  "Sunderland": [
    ...
    { name: "Patrick Roberts", position: "MID", specificPosition: "RCM", rating: 75, team: "Sunderland", flag: "https://crests.football-data.org/71.png" },
