      ...
      >
        <div className="w-full px-6 flex items-center justify-between">
                ...
                >
                  ...
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute left-0 bottom-[-6px] w-full h-[2px] bg-[#E11D48] shadow-[0_0_8px_rgba(225,29,72,0.4)]"
          ...
          <button
            ...
            className="md:hidden ml-auto transition-colors focus:outline-none text-zinc-400 hover:text-[#E11D48]"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#0B0F19] pt-[80px] px-6 md:hidden flex flex-col justify-between pb-12"
          >
                ...
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-white/5 border border-white/10 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-[8.5px] font-black uppercase text-[#E11D48] tracking-widest mt-1">OVR {profile.overallRating} • {profile.role}</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
