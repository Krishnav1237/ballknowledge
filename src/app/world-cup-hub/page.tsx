      ...
      <div className="relative z-10 max-w-8xl mx-auto px-6 pt-3 pb-6 w-full">
        <div className="w-full bg-black/45 border border-white/5 rounded-2xl shadow-2xl backdrop-blur-md overflow-hidden flex flex-col lg:h-[840px]">
          ...
          <div className="shrink-0 border-b border-white/5 bg-black/25 backdrop-blur-xs p-4 flex flex-row items-center justify-between gap-4">
            ...
            {profile && (
              <Link href="/football-iq" className="border border-white/10 hover:border-[#D97706]/40 rounded-xl p-2 px-3 bg-gradient-to-b from-black/95 to-black/60 shadow-2xl flex items-center gap-3 transition-all duration-300 group shrink-0">
                {/* Hexagonal Shield Badge */}
                <div className="w-10 h-10 bg-gradient-to-br from-[#D97706] via-[#881337] to-[#D97706] p-[1.5px] clip-path-badge shrink-0 shadow-[0_0_15px_rgba(217,119,6,0.35)] group-hover:scale-105 transition-transform duration-300">
                  <div className="w-full h-full bg-[#0A0A0A] clip-path-badge flex flex-col items-center justify-center font-display font-black">
                    ...
                    <span className="text-[5.5px] text-[#D97706] tracking-tighter leading-none mt-0.5">OVR</span>
                  </div>
                </div>
                <div className="text-left overflow-hidden">
                  <p className="text-[6.5px] font-black text-[#D97706] uppercase tracking-widest leading-none">Manager Reputation</p>
                  <p className="font-display font-black text-xs text-white group-hover:text-[#D97706] transition-colors truncate mt-0.5 leading-none">{profile.username}</p>
