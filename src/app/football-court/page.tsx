...
export default function FootballCourtRedirect() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-foreground flex flex-col justify-center items-center p-6 text-center">
      ...
      <p className="font-display font-black text-sm uppercase tracking-widest text-[#E11D48]">Upgrading to Unified Football IQ Reputation Platform...</p>
    </div>
  );
}
